  ...
  return (
    <section className="w-full gap-4 md:gap-8 grid px-6 md:px-8 lg:px-12">
      <div className="grid items-start gap-6 lg:gap-20 md: grid-cols-2 lg:grid-cols-3">
        <div className="grid md:grid-flow-row md:p-0 md:overflow-x-hidden md:grid-cols-2 md:2-full lg:col-span-2">
          <div className="md:col-span-2 span-center card-image aspect-square md:w-full w-[80vw] shadow rounded">
            <Image
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      const newHref = currentHref.includes('#')
                        ? currentHref
                        : currentHref + '#';
                      window.location.href = newHref + 'cart-aside';
                    }}
                    disabled={
                      !selectedVariant.availableForSale ??
                      fetcher.state !== 'idle'
